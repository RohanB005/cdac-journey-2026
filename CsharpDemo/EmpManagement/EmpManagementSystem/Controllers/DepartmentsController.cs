...
public class DepartmentsController : Controller
{
    ...
    public DepartmentsController(EmployeeManageDbContext context)
    {
        _context = context;
    }
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? id, [Bind("DepartmentId,DepartmentName,Employees")] Department department)
    {
